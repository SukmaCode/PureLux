    ...
    <div class="dashboard-container flex">
        ...
        <main class="flex-1 p-8 overflow-y-scroll bg-white">
            ...
            <header class="flex justify-between items-center mb-10 fade-in">
                <div>
                    <h1 class="text-3xl font-bold text-black mb-2">Laporan Pembelian</h1>
                    <p class="text-gray-600">Lihat laporan pembelian dengan tampilan elegan ✨</p>
                </div>
            ...
            <div class="content" style="background: transparent;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                    <div class="rounded-xl p-6 shadow-lg fade-in bg-white" style="border: 2px solid #d4af37;">
                        <p class="text-black text-sm font-medium">Total Pembelian</p>
                        <h2 class="text-3xl font-bold mt-2" style="color: #d4af37;"><?php echo formatCurrency($total_pembelian); ?></h2>
                    ...
                    <div class="rounded-xl p-6 shadow-lg fade-in bg-white" style="border: 2px solid #d4af37;">
                        ...
                        <h2 class="text-3xl font-bold mt-2" style="color: #d4af37;"><?php echo $total_transaksi > 0 ? formatCurrency($total_pembelian / $total_transaksi) : 'Rp 0'; ?></h2>
                        <p class="text-sm mt-1 text-gray-600">Nilai rata-rata per transaksi</p>
                    </div>

                    <div class="rounded-xl p-6 shadow-lg fade-in bg-white" style="border: 2px solid #d4af37;">
                        <p class="text-black text-sm font-medium">Status</p>
                        <h2 class="text-3xl font-bold mt-2" style="color: #d4af37;"><?php echo $total_completed; ?> / <?php echo $total_transaksi; ?></h2>
                        <p class="text-sm mt-1 text-gray-600">Selesai / Total (Pending: <?php echo $total_pending; ?>)</p>
                    </div>
                </div>
                ...
                <div class="table-container" style="background: #ffffff; border: 2px solid #d4af37; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1);">
                    <div class="table-header" style="background: linear-gradient(135deg, #d4af37 0%, #c9a961 100%); padding: 20px;">
                        <h3 class="table-title" style="color: #000000; font-size: 20px; font-weight: bold; margin: 0;">Detail Laporan Pembelian</h3>
                    </div>
                    <table class="table" style="width: 100%; border-collapse: collapse;">
                        <thead>
                            <tr style="background: rgba(212, 175, 55, 0.1);">
                                ...
                                <th style="padding: 15px; text-align: left; color: #d4af37; font-weight: 600; border-bottom: 2px solid #d4af37;">User</th>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                ...
                                <tr style="border-b: 1px solid #e0e0e0; transition: background 0.2s;" onmouseover="this.style.background='#f9f9f9'" onmouseout="this.style.background='#ffffff'">
                                    ...
                                    <td style="padding: 15px; color: #000000;"><?php echo $row['user_name'] ?? '-'; ?></td>
